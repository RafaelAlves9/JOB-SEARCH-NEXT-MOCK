         ...
         <Controller
            ...
            render={({ field: { onChange, value } }) => (
               <>
                  {!!iconLeft && (
                     <div
                        className={`text-2xl absolute left-3 ${!!label ? "top-[2.2rem]" : "top-[1.8rem]"
                           } rounded-[0.7em] z-10`}
                     >
                        {iconLeft}
                     </div>
                  ...
                  {!!iconRight &&
                     (type !== "password" || inputType === "password") && (
                        <div
                           className={`text-2xl absolute right-4 ${!!label ? "top-[2rem]" : "top-2"
                              } rounded-[0.7em] z-10`}
                           onClick={() => {
                              if (type === "password") {
                ...
                ${!disabled &&
                        "hover:border-primary-300 focus:border-primary-300 bg-white"
                        }
